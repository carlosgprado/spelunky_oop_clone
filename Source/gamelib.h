...
namespace game_framework {
	...
	public:
		...
		virtual void OnBeginState(int) {}							// 設定每次進入這個狀態時所需的初值
	...
	protected:
		...
		void GotoGameState(int state, int);							// 跳躍至指定的state
		void GotoGameState(int state, UI *);					// 跳躍至指定的state
	...
	public:
		...
		void SetGameState(int state, int level);
		void SetGameState(int state, UI *player);
